...
public class Explosion extends GameObject implements Serializable {
    ...
    public Explosion(double x, double y, int playerIBelongToNumber) {
        ...
        boundRect = new Rectangle((int)this.x - currentFrame.getImage().getWidth() / 4,
                (int)this.y - currentFrame.getImage().getHeight() / 4, currentFrame.getImage().getWidth() / 2,
                currentFrame.getImage().getHeight() / 2);
