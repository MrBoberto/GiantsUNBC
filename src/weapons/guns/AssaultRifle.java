 ...
 *
 * An assault rifle owned by a player that can be used to inflict damage upon their opponent
 *
 * @author The Boyz
 * @version 1
 */
...
public class AssaultRifle implements Weapon {
    ...
    public static final WeaponType WEAPON_TYPE = WeaponType.AssaultRifle;
