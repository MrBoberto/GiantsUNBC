//TODO: implement with new bullet code
//
...
//
//public class Fireball extends Ammo implements Projectile {
//
...
//        int textureNum = 1 + World.getWorld().getSRandom().nextInt(5);
//        try {
//            texture = ImageIO.read(new File("resources/VFX/projectile/fireball (" + textureNum + ").png"));
