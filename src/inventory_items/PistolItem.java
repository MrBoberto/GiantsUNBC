 ...
 *
 * A pistol that spawns in zones not obstructed by blocks and can be picked up and used by a player
 *
 * @author The Boyz
 * @version 1
 */
...
public class PistolItem extends InventoryItem {
    ...
    protected void updateClient(int playerNumber, int indexToRemove) {
        InventoryItemPacket inventoryItemPacket = new InventoryItemPacket(playerNumber, indexToRemove, Pistol.SERIAL);
